...
cli.responders.help = function(){
    var commands = {
        ...
        'stats' : 'Get statistics of underlying OS and resource utilization',
        'list users' : 'Show a list of all the registered users in the systems',
        'more user info --{userId}' : 'Show details of a specific user',
        'list checks --up --down' : 'Show a list of all active checks in the system, including their states. The "--up" and "--down" are both optional',
...
cli.centered = function(str){
    ...
    // Calculate the left there should be
...
cli.responders.stats = function(){
    ...
    var stats = {
        ...
        'Allocated Heap Used (%)' : Math.round(100 * (v8.getHeapStatistics().used_heap_size/v8.getHeapStatistics().total_heap_size)),
        'Available Heap Allocated (%)' : Math.round(100 * (v8.getHeapStatistics().total_heap_size/v8.getHeapStatistics().heap_size_limit)),
...
cli.responders.moreUserInfo = function(str){
    ...
    if(userId){
        ...
        _data.read('users', userId, function(err, userData){
            ...
            // Print the json obj with text highlighting
            cli.verticalSpace();
