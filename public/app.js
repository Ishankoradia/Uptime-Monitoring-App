...
// Continaer for the frontend application
var app = {};
    ...
    document.querySelector('form').addEventListener('submit', function(e){
        ...
        app.client.request(undefined,path,method,undefined,payload,function(statusCode, responsePayload){
            ...
            if(statusCode !== 200){
                ...
                var error = typeof(responsePayload.error) == 'string' ? responsePayload.error : 'Form could not be submitted. Please try again later';
